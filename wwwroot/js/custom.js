(function ($) {
  ...
  jQuery(window).on("load", function () {
    jQuery("#status").delay(4700).fadeOut("slow");
    jQuery("#preloader").delay(4700).fadeOut("slow");
  });
  ...
  jQuery(document).ready(function ($) {
    ...
    $(window).scroll(function () {
      ...
      if (window_top > 160) {
        $("#menu-web").addClass("menu_fixed animated fadeInDown");
        $("#menu-mobile").addClass("menu_fixed animated fadeInDown");
        $("#slider-area").css("margin-top", "75px");
      } else {
        $("#menu-web").removeClass("menu_fixed animated fadeInDown");
        $("#menu-mobile").removeClass("menu_fixed animated fadeInDown");
